...
// egs-tool catlet upload-directory <CatletId> <SourcePath> <TargetPath> [--overwrite] [--recursive] [--identity <path>]
//
// Uploads a directory to a catlet over the eryph channel, sharing the transfer
// logic with the VM-level 'upload-directory'.
public sealed class CatletUploadDirectoryCommand : GuestTransferCommand<CatletUploadDirectoryCommand.Settings>
{
