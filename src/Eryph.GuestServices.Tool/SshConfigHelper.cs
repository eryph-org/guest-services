...
public static class SshConfigHelper
{
    ...
    public static async Task EnsureSshConfigAsync()
    {
        ...
        // Quote the include patterns: the LocalAppData root can contain spaces
        // (e.g. C:\Users\Jane Doe\...), and an unquoted ssh_config argument with a
        // space is parsed as multiple tokens, so the include would be ignored.
        var config = $"""
                       {Border}
        ...
        string keyFilePath)
    {
        ...
        // Quote the key path: a BYOK/profile path may contain spaces.
