...
public static class SshConfigHelper
{
    ...
    public static async Task EnsureEryphSshConfigAsync()
    {
        ...
        string keyFilePath)
    {
        ...
        builder.AppendLine($"Host {string.Join(' ', alias)}");
        ...
        // anyway as the eryph guest services only supports public key authentication.
    ...
    public static Task CleanupCatletConfigs(IList<string> catletIds) => Task.Run(() =>
    {
