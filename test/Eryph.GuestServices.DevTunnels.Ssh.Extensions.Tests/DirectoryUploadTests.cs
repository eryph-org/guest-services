...
[Collection("e2e")]
public sealed class DirectoryUploadTests : IDisposable
{
    private readonly string _path;

    public DirectoryUploadTests()
    {
    ...
    [Fact]
    public async Task UploadDirectoryLogic_NonRecursive_ShouldUploadOnlyRootFiles()
    {
        ...
        var result = await helper.ClientSession.UploadDirectoryAsync(
            sourceDir,
            targetDir,
            overwrite: false,
            recursive: false);
    ...
    [Fact]
    public async Task UploadDirectoryLogic_Recursive_ShouldUploadAllFilesIncludingSubdirectories()
    {
